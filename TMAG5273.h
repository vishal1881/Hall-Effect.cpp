...
// Register definition based on TMAG5273 datasheet
...
#define REG_TEMP_CONFIG_DEFAULT 0x00
#define REG_INTERRUPT_CONFIG_DEFAULT 0x01
...
typedef enum tmag5273_mag_range {
    TMAG5273_MAG_RANGE_40MT = 40,     
    TMAG5273_MAG_RANGE_80MT = 80,     
    TMAG5273_MAG_RANGE_133MT = 133,   
    TMAG5273_MAG_RANGE_266MT = 266    
